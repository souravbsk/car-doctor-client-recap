  ...
  return (
    <div className="mt-32">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10">
        <div className="text-center border rounded-lg p-6 flex flex-col justify-center items-center space-y-4">
            <img src={ExpertTeam} alt="" />
            <h3 className="font-semibold">Expert Team</h3>
        </div>
        <div className="text-center bg-[#FF3811] border rounded-lg p-6 flex flex-col justify-center items-center space-y-4">
            <img src={watch} alt="" />
